...
INSERT INTO data_type (data_type_id, type) VALUES (4, 'TIMESTAMP');
...
INSERT INTO domain (domain_id, description, eng_init_name, eng_name, kor_name, length, data_type_id) VALUES(4, '날짜와 시분초', 'DTIME', 'Datetime', '일시', '14', 4);
